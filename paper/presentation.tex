...
something about the choice of p or q and the local closure hypothesis...
...
Well-typed relation alone is insufficient to prove the theorem. The cut typing
rule does not specify the subprocesses are related i.e. are eventually dual
