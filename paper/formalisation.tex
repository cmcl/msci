...
unnecessary verbage and this is what the library allows to omit \todo{example
  of using the forwards tactic} an example of the so called forwards tactic is
