...
\todo{what's another way to say ``too small'' vs. ``too large''}.
...
Afer inverting \key{WT} and specialising the resulting hypotheses, regarding
...
does the job\todo{keep (and explain) this?}.
...
performed by induction on GV terms. \todo{could take about opening the
  multiple binder let. multi but not as in literature}
...
\subsection{CPS translation from GV to CP}
