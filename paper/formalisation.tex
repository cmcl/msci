...
deep embedding~\cite{??,??,??}, where sequents and derivations are represented
explicitly rather than just the conclusion as in the shallow embedding adopted
here. It is unclear whether the cut elimination theorem can be rescued in the
current setting or not, but previous work suggests it is better to use other
approaches. It is worth noting that \citeauthor{Tews:2013}'s Coq development
significant; about 36,000 lines.
