...
Lemma abp_lossyAD_procR_typing :
...
Proof.
  ...
  apply TypPrefixInput with
      (s:=SDual (SNack1 r k r' (token_of_bool i)))
  ...
  Case "+ err2!i; err2!x; lossy(err1,err2)".
    ...
    eapply TypPrefixOutput with (s:=SAck r' (token_of_bool i))
        ...
        (t:=SAck1 r' (token_of_bool i));
      [apply TRAckA with (s:=r') (bit:=token_of_bool i); assumption
    ...
    eapply TypPrefixOutput with (s:=SAck1 r' (token_of_bool i))
        (rho:=TSingleton k) (t:=SAck r' (token_of_bool i));
