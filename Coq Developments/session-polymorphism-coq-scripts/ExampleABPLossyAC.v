...
Lemma abp_lossyAC_procR_typing :
...
Proof.
  ...
  apply TypPrefixInput with
      (s:=SDual (SNack r k r' (token_of_bool (negb i))))
  ...
  (* err1?x; rest *)
  apply TypPrefixInput with
      (s:=SDual (SNack1 r k r' (token_of_bool (negb i))))
  ...
  Case "lossy(err1,err2)".
    ...
    eapply TypPrefixOutput with
        (s:=SDual (SLossy1 (SNack r k r' (token_of_bool (negb i)))
          (SAck r (token_of_bool i))))
        (rho:=TChannel (SAck r (token_of_bool i))) (t:=SDual SEpsilon);
      [apply trdual_w_mdual_involution; constructor
        | left; discriminate
        | constructor; [ctx_wf; discriminate_w_list | x_in_G]
        | constructor; [ctx_wf; discriminate_w_list | x_in_G]
  ...
  Case "+ err2!i; err2!x; lossy(err1,err2)".
    ...
    eapply TypPrefixOutput with (s:=SAck2 r (token_of_bool i))
        (rho:=TSingleton k) (t:=SNack r k r' (token_of_bool (negb i)));
    ...
    eapply TypPrefixOutput with (s:=SDual SLossy)
        (rho:=TChannel (SDual (SNack r k r' (token_of_bool (negb i)))))
        (t:=SDual (SLossy1 (SNack r k r' (token_of_bool (negb i)))
          (SNack r k r' (token_of_bool (negb i)))));
      [apply trdual_w_mdual_involution;
          apply TRLossyB with (i:=negb i) (r:=r) (k:=k) (r':=r');
          reflexivity
        | left; discriminate
        | constructor; [ctx_wf; discriminate_w_list | x_in_G]
        | constructor; [ctx_wf; discriminate_w_list | x_in_G]
    ...
    eapply TypPrefixOutput with
        (s:=SDual (SLossy1 (SNack r k r' (token_of_bool (negb i)))
          (SNack r k r' (token_of_bool (negb i)))))
        (rho:=TChannel (SNack r k r' (token_of_bool (negb i))))
        (t:=SDual SEpsilon);
      [apply trdual_w_mdual_involution; constructor
        | left; discriminate
        | constructor; [ctx_wf; discriminate_w_list | x_in_G]
